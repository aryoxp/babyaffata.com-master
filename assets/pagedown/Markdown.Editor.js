...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
			...
			buttons.more = makeButton("wmd-more-button", "Add more excerpt separation", "-260px", bindCommand("doMore"));
			makeSpacer(2);
			buttons.clear = makeButton("wmd-clear-button", "Clear alignment separator", "-280px", bindCommand("doClear"));
	...
	commandProto.doClear = function(chunk, postProcessing) {
		chunk.startTag = "<!--clear-->";
		chunk.selection = "";
        chunk.skipLines(1, 1, true);
	}
